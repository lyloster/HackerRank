...
//used to keep track of current node, data field is irrelevant
//constructor requires a data argument when constructing a new node
...
//traversal until getting to the right position
while(position != 1){
    n = n->next;
    position --;
}
